...
class DrawTexture3DVC: UIViewController {
    
    var esView: Draw3DTextureView!

    override func viewDidLoad() {
        super.viewDidLoad()
        
        esView = Draw3DTextureView.init(frame: CGRect.init(x: 0, y: 0, width: self.view.frame.size.width, height: self.view.frame.size.height))
